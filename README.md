...
## 1. Crear el archivo .gitinore

Configurar el archivio .gitinore para restringir los archivos a sincronizar.
...
* UPDATED - Actualizar módulos del sistema. 
* FIXED - Corregir errores del sistema.

## 4 . Sincronizar los cambios con el repositorio
Sincronizar los cambios con el repositroio 
````shell
